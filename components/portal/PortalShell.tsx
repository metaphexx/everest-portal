  ...
  return (
    <div className="ev-shell">
      ...
      <div className="ev-mobilebar">
        ...
        <img className="ev-mobilebar-logo" src="/student-portal-logo.png" alt="Everest Tutoring - Student Portal" width={400} height={200} {...({ fetchpriority: "high" } as object)} decoding="async" />
      </div>
