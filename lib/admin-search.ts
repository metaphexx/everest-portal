...
const DESTINATIONS: Indexable[] = [
  ...
  { name: "Tutors", meta: "Staff, duties and contact details", kind: "Page", color: "#0E7AC2", page: "/admin/tutors", keywords: "staff roster teachers duties leave", boost: 30 },
  { name: "Students", meta: "Enrolments, attendance and parent contacts", kind: "Page", color: "#22A05B", page: "/admin/students", keywords: "roster parents attendance trial withdrawn", boost: 30 },
